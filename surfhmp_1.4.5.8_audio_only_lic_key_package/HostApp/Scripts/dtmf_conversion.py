...
{"tool_req":{
  ...
  "data":{
    ...
    "EVG":{"enabled":true, "convert_RTP_events_to_inband": "all"}
  }
}}
"""
...
{"tool_req":{
  ...
  "data":{
    ...
    "decoder":{"type":"G.711alaw"},
    "encoder":{"type":"G.711alaw", "packet_duration":20},
    "RTP":{"local_udp_port":7000, "remote_udp_port":8000, "remote_ip":"127.0.0.1", "dtmf_out_payload_type":101, "dtmf_in_payload_type":101},
    "EVD":{"enabled":true, "events":["DTMF_GROUP"]},
    "EVG":{"enabled":true}
  }
}}
...
hmp.send_cmd(cmd_configure_tool3)
